...
public class SyncLocalCallsWorker extends Worker {

    public static final String TAG = "SYNC_LOCAL_CALLS_WORKER";

    public SyncLocalCallsWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
